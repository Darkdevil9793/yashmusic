    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:3] == "sta":
            m = await message.reply_text(
                "🔎 Fetching your personal stats by darkdevil.!"
            )
        ...
        if name[0:3] == "sud":
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    f"{message.from_user.mention} has just started Yash Music bot to check <code>SUDOLIST</code>\n\n**USER ID:** {sender_id}\n**USER NAME:** {sender_name}",
                )
            return
        if name[0:3] == "lyr":
...
⚡️ __Searched Powered By {config.MUSIC_BOT_NAME}__"""
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    f"{message.from_user.mention} has just started Yash Music bot to check <code>VIDEO INFORMATION</code>\n\n**USER ID:** {sender_id}\n**USER NAME:** {sender_name}",
                )
    else:
        try:
        ...
        photo=f"https://telegra.ph/file/879394a29fb6480ca12e3.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
💥 𝐇𝐞𝐥𝐥𝐨, 𝐈 𝐚𝐦 𝐒𝐮𝐩𝐞𝐫𝐟𝐚𝐬𝐭 𝐇𝐢𝐠𝐡 𝐐𝐮𝐚𝐥𝐢𝐭𝐲
𝐍𝐨 𝐋𝐚𝐠 𝐕𝐂 𝐌𝐮𝐬𝐢𝐜 𝐏𝐥𝐚𝐲𝐞𝐫 𝐁𝐨𝐭.

┏━━━━━━━━━━━━━━━━━┓
┣★ 𝐎𝐰𝐧𝐞𝐫'𝐱𝐃 : [𝗬𝗮𝘀𝗵](https://t.me/@Hiiuigf)
┣★ 𝐎𝐰𝐧𝐞𝐫'𝐱𝐃 : [𝗗𝗮𝗿𝗸 𝗱𝗲𝘃𝗶𝗹](https://t.me/darkdevil898)
┣★ 𝗔𝘀𝘀𝗶𝘀𝘁𝗮𝗻𝘁 » : [𝗔𝗹𝗲𝘅 𝗕𝗮𝗱 𝗛𝗮𝗰𝗸𝗲𝗿](https://t.me/ALEXBADHACKER)
┣★ 𝗚𝗿𝗼𝘂𝗽 » : [𝗡𝗮𝘄𝗮𝗯𝗼 𝗞𝗮 𝗦𝗵𝗲𝗵𝗲𝗿](https://t.me/+BGIiDOFoWIplYTY1)
┣★ 𝐂𝐡𝐚𝗻𝗻𝗲𝗹𓂸 » : [𝗛𝗮𝗰𝗸𝗶𝗻𝗴 𝗖𝗵𝗮𝘁](https://t.me/darkdevil9793)
┗━━━━━━━━━━━━━━━━━┛

💞 𝐉𝐮𝐬𝐭 𝐀𝐝𝐝 𝐌𝐞 » 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩 𝐀𝐧𝐝
𝐄𝐧𝐣𝐨𝐲 𝐒𝐮𝐩𝐞𝐫 𝐐𝐮𝐚𝐥𝐢𝐭𝐲 ❥︎𝐌𝐮𝐬𝐢𝐜 𝗯𝘆 𝗱𝗮𝗿𝗸𝗱𝗲𝘃𝗶𝗹.
━━━━━━━━━━━━━━━━━━━━━━━━**""",
...
━━━━━━━━━━━━━━━━━━━━━━━━**""",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ 𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩 𝗕𝘆 𝗗𝗮𝗿𝗸𝗱𝗲𝘃𝗶𝗹 ❱ ➕", url=f"https://t.me/{app.username}?startgroup=true"),
                ],
                [
                    InlineKeyboardButton(
                        text="⚙ ❰ 𝐎𝐩𝐞𝐧 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬 𝐌𝐞𝐧𝐮 By Darkdevil ❱ ⚙", callback_data="settings_back_helper")
                ]
           ]
        ),
           )
        if await is_on_off(config.LOG):
            ...
            return await app.send_message(
                config.LOG_GROUP_ID,
                f"{message.from_user.mention} has just started Yash Music Bot.\n\n**USER ID:** {sender_id}\n**USER NAME:** {sender_name}",
            )
