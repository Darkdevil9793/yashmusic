            ...
            if datetime.now() > timer:
                ...
                try:
                    await app.send_message(
                        chat_id,
                        "Yash Music Bot has left voice chat due to inactivity to avoid overload on servers. No-one was listening to the bot on voice chat. Please Contact Dark Devil",
                    )
                except:
                    continue
