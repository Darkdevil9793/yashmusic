...
OWNER_ID = list(map(int, getenv("OWNER_ID", "5162470641").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/darkdevil9793")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/https://t.me/+BGIiDOFoWIplYTY1")
