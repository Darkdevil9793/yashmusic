...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("darkdevil9793")
                await self.two.join_chat("darkdevil979")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("darkdevil9793")
                await self.three.join_chat("darkdevil979")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("darkdevil9793")
                await self.four.join_chat("darkdevil979")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("darkdevik9793")
                await self.five.join_chat("darkdevil979")
