...
async def init():
    ...
    LOGGER("YASH_PLAYER").info("Bikash Player Bot Started Successfully")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("YASH_PLAYER").info("Stopping Yash Player Bot! GoodBye")


# Power By @darkdevil898 & @ALEXBADHACKER
# Join @darkdevil979 For More Update
# Join @darkdevil898 For Hack
# Join Our Chats @darkdevil979 & @darkdevil9793 devil9793 3 